...
createUserWithEmailAndPassword(auth, email.current.value, password.current.value)
  .then((userCredential) => {
    ...
    updateProfile(user, {
      displayName: name.current.value, photoURL: "https://avatars.githubusercontent.com/u/71220416?v=4"
    }).then(() => {
  ...
  return (
    <div>
      ...
      <form onSubmit={(e) => e.preventDefault()} className='w-3/12 my-36 mx-auto right-0 left-0 absolute p-12 bg-black bg-opacity-80 text-white'>
